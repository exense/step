...
public class ApCommand implements Callable<Integer> {
    ...
    public static abstract class AbstractApCommand extends StepConsole.AbstractStepCommand {
        ...
        @CommandLine.Option(names = {"-p", "--package"}, paramLabel = "<Package>", description = "The path to the automation-package.yaml file, folder or the archive containing it. Maven coordinate (mvn:groupId:artefactId:version[:classifier:type]) are supported.")
