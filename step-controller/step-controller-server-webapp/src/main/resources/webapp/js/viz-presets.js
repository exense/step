...
var addErrorsOverTimeTpl = function(widgetsArray, entityName){
	...
	var standalone = new Widget(getUniqueId(), new DefaultWidgetState(), new DashletState(entityName + " errors over time", false, 0, {}, new ChartOptions('stackedAreaChart', false, true), new Config('Off', false, false, ''), new RTMAggBaseTemplatedQueryTmpl("cnt", "auto", summaryTransform, "name;rnStatus"), new DefaultGuiClosed(), new DefaultInfo()));
	widgetsArray.push(standalone);
};
