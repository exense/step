...
public class ErrorMapSerializer extends JsonSerializer<Map<String, Integer>> {

	public ErrorMapSerializer() {
		super();
	}

	@Override
	public void serialize(Map<String, Integer> value, JsonGenerator jgen, SerializerProvider provider)
