...
public class AbstractRemoteAccessorImpl<T extends AbstractIdentifiableObject> extends AbstractRemoteClient implements Accessor<T>{

	protected final String path;
	protected final Class<T> entityClass;
	
	public AbstractRemoteAccessorImpl(String path, Class<T> entityClass) {
		super();
		this.path = path;
		this.entityClass = entityClass;
	}
	
	public AbstractRemoteAccessorImpl(ControllerCredentials credentials, String path, Class<T> entityClass) {
		super(credentials);
		this.path = path;
		this.entityClass = entityClass;
	}
