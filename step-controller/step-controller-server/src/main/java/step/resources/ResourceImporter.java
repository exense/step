	...
	public void accept(Object t, ImportContext importContext) {
		if(t instanceof Resource) {
			...
			if(importConfiguration.isOverwrite()) {
				...
				//Revisions were processed and ids replaces in the tmp collection, but the field currentRevisionId of resources still referent the original IDs, so we need to get the new one
