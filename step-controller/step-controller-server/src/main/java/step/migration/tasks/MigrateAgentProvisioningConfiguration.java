 ...
 *
 */
public class MigrateAgentProvisioningConfiguration extends MigrationTask {

	public static final String AUTOSCALING_SETTINGS = "autoscalingSettings";

	private final Collection<Document> planCollection;

	public MigrateAgentProvisioningConfiguration(CollectionFactory collectionFactory, MigrationContext migrationContext) {
