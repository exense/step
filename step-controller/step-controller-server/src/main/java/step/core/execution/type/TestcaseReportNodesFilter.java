...
public class TestcaseReportNodesFilter implements TableQueryFactory {
	
	public TestcaseReportNodesFilter() {
		super();
	}
	...
	public Filter buildAdditionalQuery(JsonObject filter) {		
		...
		fragments.add(Filters.equals("_class", TestCaseReportNode.class.getName()));
