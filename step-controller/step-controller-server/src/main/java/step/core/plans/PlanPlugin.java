...
public class PlanPlugin extends AbstractControllerPlugin {
	...
	protected void createScreenInputDefinitionsIfNecessary(GlobalContext context) {
		...
		nameInput.setValueHtmlTemplate("<entity-icon entity=\"stBean\" entity-name=\"plans\"/> <plan-link entity-id=\"stBean.id\" description=\"stBean.attributes.name\" st-options=\"stOptions\"/>");
