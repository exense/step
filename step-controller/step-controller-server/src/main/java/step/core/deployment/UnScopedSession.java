 ...
 * the scope of the operations is not restricted to tenant of entities.
 * <p>
 * This class has been introduced to perform {@code step.plugins.timeseries.TimeSeriesService} requests
 * unrestricted to a specific project. The implementation should ensure that only entities not attached to a project can be accessed
 * <p>
