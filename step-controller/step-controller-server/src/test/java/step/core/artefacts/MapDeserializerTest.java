...
public class MapDeserializerTest {
	...
	public void test() throws IOException {
		ObjectMapper m = DefaultJacksonMapperProvider.getObjectMapper();
		...
		assertEquals("Test", ((TestBean2)b2.getMap().get("key1")).getTest());
		assertEquals("Test", ((TestBean2)b2.getMap().get("key2")).getTest());
		assertNull(b2.getMap().get("key3"));
	}
