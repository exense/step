...
public class KeyValueParser extends Parser {
    ...
    public static class ParseContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(KeyValueParser.EOF, 0);
        }
    ...
    public static class KeyValueContext extends ParserRuleContext {
        ...
        public TerminalNode EQ() {
            return getToken(KeyValueParser.EQ, 0);
        }
    ...
    public static class KeyContext extends ParserRuleContext {
        public TerminalNode WORD() {
            return getToken(KeyValueParser.WORD, 0);
        }

        public TerminalNode STRING() {
            return getToken(KeyValueParser.STRING, 0);
        }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public TerminalNode DYNAMIC_EXPRESSION() {
            return getToken(KeyValueParser.DYNAMIC_EXPRESSION, 0);
        }
