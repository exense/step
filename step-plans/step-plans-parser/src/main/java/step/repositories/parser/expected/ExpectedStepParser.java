...
public class ExpectedStepParser extends Parser {
    ...
    public static class ParseContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ExpectedStepParser.EOF, 0);
        }
    ...
    public static class CheckExprContext extends CheckExpressionContext {
        ...
        public TerminalNode EQ() {
            return getToken(ExpectedStepParser.EQ, 0);
        }

        public TerminalNode REGEX() {
            return getToken(ExpectedStepParser.REGEX, 0);
        }

        public TerminalNode CONTAINS() {
            return getToken(ExpectedStepParser.CONTAINS, 0);
        }

        public TerminalNode BEGINS() {
            return getToken(ExpectedStepParser.BEGINS, 0);
        }

        public TerminalNode ENDS() {
            return getToken(ExpectedStepParser.ENDS, 0);
        }

        public TerminalNode GREATER_THAN_OR_EQUALS() {
            return getToken(ExpectedStepParser.GREATER_THAN_OR_EQUALS, 0);
        }

        public TerminalNode GREATER_THAN() {
            return getToken(ExpectedStepParser.GREATER_THAN, 0);
        }

        public TerminalNode LESS_THAN_OR_EQUALS() {
            return getToken(ExpectedStepParser.LESS_THAN_OR_EQUALS, 0);
        }

        public TerminalNode LESS_THAN() {
            return getToken(ExpectedStepParser.LESS_THAN, 0);
        }

        public TerminalNode IS_NULL() {
            return getToken(ExpectedStepParser.IS_NULL, 0);
        }

        public TerminalNode NOT() {
            return getToken(ExpectedStepParser.NOT, 0);
        }
        ...
        public CheckExprContext(CheckExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class OutputAttributeNameContext extends ParserRuleContext {
        public TerminalNode WORD() {
            return getToken(ExpectedStepParser.WORD, 0);
        }

        public TerminalNode STRING() {
            return getToken(ExpectedStepParser.STRING, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_outputAttributeName;
        }
    ...
    public static class AttributeValueContext extends ParserRuleContext {
        public TerminalNode NUM() {
            return getToken(ExpectedStepParser.NUM, 0);
        }
        ...
        public TerminalNode BOOL() {
            return getToken(ExpectedStepParser.BOOL, 0);
        }
