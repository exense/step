...
public class ErrorRateView extends AbstractTimeBasedView<ErrorRateEntry> {
	...
	@Override
	public void onReportNodeRemoval(AbstractTimeBasedModel<ErrorRateEntry> model, ReportNode node) {
		removeErrorPointIfAny(model, node);
	}

	private void removeErrorPointIfAny(AbstractTimeBasedModel<ErrorRateEntry> model, ReportNode node) {
		ErrorRateEntry e = createPoint(node);
		if (e != null) {
	...
	@Override
	public void onErrorContributionRemoval(AbstractTimeBasedModel<ErrorRateEntry> model, ReportNode node) {
		removeErrorPointIfAny(model, node);
	}
