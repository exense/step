...
public class TestStepReportNodeFilter implements CollectionQueryFactory {

	public String buildAdditionalQuery(JsonObject filter) {
		StringBuilder query = new StringBuilder();
		query.append("executionID: '" + filter.getString("eid") + "', $or: [ { _class: 'step.artefacts.reports.TestStepReportNode' }, { status: 'TECHNICAL_ERROR'} ]");
