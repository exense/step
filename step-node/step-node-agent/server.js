...
const agentContext = {
  ...
  tokenSessions: [],
  tokenProperties: [],
  properties: agentConf.properties || {},
  controllerUrl: agentConf.gridHost,
  ...
  gridConnectTimeout: agentConf.gridConnectTimeout,
  gridReadTimeout: agentConf.gridReadTimeout
}
