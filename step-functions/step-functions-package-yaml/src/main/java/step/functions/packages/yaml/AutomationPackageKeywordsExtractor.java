...
import step.functions.packages.yaml.model.AutomationPackageMetadata;
        ...
        try (InputStream is = new FileInputStream(automationPackageJar)) {
            ...
            try {
                ...
                try (FileInputStream yamlInputStream = new FileInputStream(yamlMetadata)) {
                    ...
                    AutomationPackageMetadata metadata = objectMapper.readValue(yamlInputStream, AutomationPackageMetadata.class);
