...
public class YamlKeywordPackageSchemaGeneratorTest {
    private static final Logger log = LoggerFactory.getLogger(YamlKeywordPackageSchemaGeneratorTest.class);
    ...
    public void generateJsonSchema() throws IOException, JsonSchemaPreparationException {
        ...
        YamlKeywordPackageSchemaGenerator schemaGenerator = new YamlKeywordPackageSchemaGenerator("step", YamlPlanVersions.ACTUAL_VERSION);
