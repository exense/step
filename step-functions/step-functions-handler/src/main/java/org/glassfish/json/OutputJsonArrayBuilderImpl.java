...
public class OutputJsonArrayBuilderImpl implements JsonArrayBuilder {
	private ArrayList<JsonValue> valueList;
	private final BufferPool bufferPool;

	OutputJsonArrayBuilderImpl(BufferPool bufferPool) {
		this.bufferPool = bufferPool;
	}

	OutputJsonArrayBuilderImpl(JsonArray array, BufferPool bufferPool) {
		this.bufferPool = bufferPool;
		valueList = new ArrayList<>();
		valueList.addAll(array);
	}

	OutputJsonArrayBuilderImpl(Collection<?> collection, BufferPool bufferPool) {
		this.bufferPool = bufferPool;
		valueList = new ArrayList<>();
		populate(collection);
	}
	...
	public JsonArrayBuilder add(String value) {
		validateValue(value);
		addValueList(new OutputJsonStringImpl(value));
		return this;
	}
	...
	public JsonArrayBuilder add(int index, String value) {
		validateValue(value);
		addValueList(index, new OutputJsonStringImpl(value));
		return this;
	}
	...
	public JsonArrayBuilder set(int index, String value) {
		validateValue(value);
		setValueList(index, new OutputJsonStringImpl(value));
		return this;
	}
	...
	public JsonArray build() {
		...
		valueList = null;
		return new OutputJsonArrayBuilderImpl.JsonArrayImpl(snapshot, bufferPool);
	}
