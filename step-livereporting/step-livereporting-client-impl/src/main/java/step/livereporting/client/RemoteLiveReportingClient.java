...
public class RemoteLiveReportingClient implements LiveReportingClient {
    ...
    private final RestUploadingLiveMetricSampleDestination liveMetricSampleDestination;
    ...
    public RemoteLiveReportingClient(Map<String, String> contextProperties, Map<String, String> agentProperties, ExecutorService executorService, AtomicReference<Object> websocketContainer) {
        ...
        if (liveReportingContextId != null) {
            ...
            if (baseUrl != null) {
                ...
                String metricSamplesUrl = String.format("%s/rest/live-reporting/%s/metric-samples", baseUrl, liveReportingContextId);
                liveMetricSampleDestination = new RestUploadingLiveMetricSampleDestination(metricSamplesUrl);
            } else {
                liveMeasureDestination = null;
                liveMetricSampleDestination = null;
            }
        } else {
            // API liveReporting knows how to handle null values
            liveMeasureDestination = null;
    ...
    @Override
    public LiveMetricSampleDestination getLiveMetricSampleDestination() {
        return liveMetricSampleDestination;
    }
