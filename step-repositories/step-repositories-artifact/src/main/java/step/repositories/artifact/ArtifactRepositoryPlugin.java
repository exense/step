...
public class ArtifactRepositoryPlugin extends AbstractControllerPlugin {
    ...
    public void serverStart(GlobalContext context) throws Exception {
        ...
        AutomationPackageManager automationPackageManager = context.require(AutomationPackageManager.class);
        MavenArtifactRepository mavenRepository = new MavenArtifactRepository(planAccessor, context.getResourceManager(), controllerSettingAccessor, configuration, automationPackageManager.getPackageReader());
        ResourceArtifactRepository resourceRepository = new ResourceArtifactRepository(planAccessor, context.getResourceManager(), automationPackageManager.getPackageReader());
