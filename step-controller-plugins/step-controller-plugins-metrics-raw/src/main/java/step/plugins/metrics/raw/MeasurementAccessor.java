...
public class MeasurementAccessor {
    ...
    private static Document getRawMeasurement(Map o) {
        ...
        document.remove(MetricsExecutionPlugin.SCHEDULE);
        document.remove(MetricsExecutionPlugin.EXECUTION_DESCRIPTION);
        document.remove(MetricsExecutionPlugin.PLAN);
        return document;
    }
