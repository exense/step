 ...
 * <p>
 * This class is intentionally separate from {@link MetricsExecutionPluginTest} to avoid
 * the static {@code measurementHandlers} list accumulating handlers across tests.
 */
public class MetricsExecutionPluginMetricsTest extends AbstractKeyword {
